...
router.post("/", async (req, res) => {
  //req= requesting data from frontend side and responsing to the front end in json format
  ...
  try {
    ...
    if (isExistingEmail.length > 0) {
      //.length bcz we took find() which represents in array so to access .length
